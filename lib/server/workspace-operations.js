...
async function writeMarketing(input, context) {
  ...
  if (input.action === "save") {
    ...
    if (input.designId) {
      ...
      const result = await updateDesign(input.designId, { elements: input.elements, canvas_width: 595, canvas_height: 420 }, context);
  ...
  if (input.action === "export") {
    ...
    return { designId, downloadUrl: exportResult.storageKey };
  }
