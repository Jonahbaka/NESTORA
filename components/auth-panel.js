  ...
  return (
    <div className="auth-page">
      <div className="auth-visual">
        <Image src="/images/nestora/hero-abuja-residence.webp" alt="A welcoming contemporary Abuja home at sunset" fill priority sizes="(max-width: 850px) 100vw, 54vw" />
        <span />
        <div>
      ...
      <div className="auth-main">
        ...
        <div className="auth-card">
          ...
          <p>{mode === "signin" ? "Sign in to continue your property journey." : "One account for stays, homes, conversations and communities."}</p>
          ...
          <form onSubmit={submit}>
            ...
            <button className="button button--coral auth-submit" type="submit" disabled={loading}>{loading ? "Please wait..." : mode === "signin" ? "Sign in" : "Create account"}<ArrowRight size={17} /></button>
          </form>
